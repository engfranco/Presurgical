...
# XXX Meneguzzi, aqui gera uma imagem de movimento
 #1dplot -volreg -dx 2 -sepsc1 -xlabel Time LING004.LET_mc.1D
1dplot -volreg -dx 2 -sepsc1 -png MOTION.${study}${subj}.${epi} -title "movimento" -xlabel Time motion_demean.1D

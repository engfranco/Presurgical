...
# Nomeação
#set task6_number = 004

# Rima
set task7_number = 003

# Verbos
set task8_number = 002

# Pseudopalavras
XXXset task9_number1 = XXX
XXXset task9_number2 = XXX
...
#	${scripts_dir}/create_directories.sh ${study} ${subj} ${analysisdirectory} ${task9_name} ${task9_number1} ${task9_number2}
	...
	# MOTOR Mão - 1
	${scripts_dir}/create_script_motor.sh_023 ${study} ${subj} ${analysisdirectory} ${task1_name} ${scripts_dir}
...
#	${scripts_dir}/create_script_ver.sh ${study} ${subj} ${analysisdirectory} ${task8_name} ${scripts_dir}
	...
	# MOTOR Mão - 1
	${scripts_dir}/open_images_MOT.V2.0.sh_023 ${study} ${subj} ${task1_name} ${subjdirectory}

...
-com "SET_OVERLAY A.rall_func2ANAT.nii.gz 1 1" \
...
plugout_drive \
-com "SAVE_PNG A.axialimage ${subj_loc}/figures/${study}${subject}.${scan}.axial.png" \
-com "SAVE_PNG A.sagittalimage ${subj_loc}/figures/${study}${subject}.${scan}.sagittal.png" \
-com "SAVE_PNG A.coronalimage ${subj_loc}/figures/${study}${subject}.${scan}.coronal.png" \
-com "QUIT" \
-quit

...
-polort 2 \
-num_stimts 9 \
-stim_times 1 ${stim_loc}/stim_timing_VIS_L.txt 'BLOCK(20,1)' -stim_label 1 left \
-stim_times 2 ${stim_loc}/stim_timing_VIS_R.txt 'BLOCK(20,1)' -stim_label 2 right \
-stim_times 3 ${stim_loc}/stim_timing_VIS_B.txt 'BLOCK(20,1)' -stim_label 3 both \

...
###############################################
3dresample -rmode Cu -master ${study}${subject}.ANAT+orig.HEAD -prefix stats.SUBJ.RESAMP+orig -inset stats.SUBJ+orig.HEAD'[20]'
...
plugout_drive \
-com "SAVE_PNG A.axialimage ${subjdirectory}/figures/${study}${subject}.${scan}.axial.png" \
-com "SAVE_PNG A.sagittalimage ${subjdirectory}/figures/${study}${subject}.${scan}.sagittal.png" \
-com "SAVE_PNG A.coronalimage ${subjdirectory}/figures/${study}${subject}.${scan}.coronal.png" \
-com "QUIT" \
-quit

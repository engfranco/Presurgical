...
afni_proc.py \
	...
	-blur_size 6 					\
    	-regress_stim_times \
    		${script_folder}/stim_timing_LIST_FRASE.txt \
    		${script_folder}/stim_timing_LIST_PERGUNTA.txt \
    		${script_folder}/stim_timing_LIST_BASELINE.txt \
	-regress_stim_labels FRASE PERGUNTA BASELINE  	\
	-regress_basis_multi                            \
		'BLOCK(6,1)' 'BLOCK(4,1)' 'BLOCK(24,1)' \
	-regress_opts_3dD                           \
                -gltsym 'SYM: +FRASE -BASELINE'             \
                -glt_label 1 FRASE_vs_BASE     \
